...
class AgentManager(Base):
    ...
    def register_agent(self, agent_path):
        ...
        self._call('RegisterAgent', 'o', agent_path, reply_handler=on_registered, error_handler=on_register_failed)
    ...
    def unregister_agent(self, agent_path):
        ...
        self._call('UnregisterAgent', 'o', agent_path, reply_handler=on_unregistered,
